...
const UIStrings = {
  /** Title of a Lighthouse audit that provides detail on the homepage installability of a website. This descriptive title is shown to users when a webapp is installable. */
  title: 'Web app manifest meets the installability requirements',
  /** Title of a Lighthouse audit that provides detail on the homepage installability of a website. This descriptive title is shown to users when a webapp is not installable. */
